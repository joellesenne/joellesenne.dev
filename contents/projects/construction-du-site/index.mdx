...
> J’ai choisi [Gatsby.js](https://www.gatsbyjs.org/) (un générateur de site statique basé sur [React.js](https://reactjs.org/)) pour la création du [site](https://joellesenne.xyz).
...
Enfin, le déploiement du site peut être automatisé grâce à l’utilisation d’un [dépôt Github](https://github.com/), avec [Netlify](https://www.netlify.com/) et [OVH](https://www.ovh.com/fr/) par exemple.
...
Retrouver le site sur mon dépôt [Github](https://github.com/joellesenne/joellesenne.dev) pour en apprendre plus. J’espère que cet article vous a plu, en espérant vous revoir prochainement.
